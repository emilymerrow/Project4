...
<p>
  Welcome to ChoreBusters' Privacy Policy! We aim to make managing chores and allowances fun for you and your kids. Your privacy is important to us, so let's discuss the essentials.
</p>
<h2 className="ui header subHeader" style={{ fontWeight: 'bold', fontSize: '2em', textDecoration: 'underline' }}>
  1. The Top-Secret Information We Collect
</h2>
<p className="text" style={{ fontSize: '1.2em', lineHeight: '1.5' }}>
  We know you're a super secret agent, but we still need some basic info to make ChoreBusters work. This includes your name, email address, and a password to protect your account from evil villains.
</p>
<h2 className="ui header subHeader" style={{ fontWeight: 'bold', fontSize: '2em', textDecoration: 'underline' }}>
  2. How We Use Your Classified Data
</h2>
<p className="text" style={{ fontSize: '1.2em', lineHeight: '1.5' }}>
...
<p className="text" style={{ fontSize: '1.2em', lineHeight: '1.5' }}>
  We use high-tech gadgets and gizmos to keep your information locked up tight. Your data is guarded by state-of-the-art security measures, so you can focus on your mission to become the ultimate chore master.
        ...
        <h2 className="ui header subHeader" style={{ fontWeight: 'bold', fontSize: '2em', textDecoration: 'underline' }}>
  4. Your Privacy Rights as a Superhero
</h2>
<p className="text" style={{ fontSize: '1.2em', lineHeight: '1.5' }}>
...
<h2 className="ui header subHeader" style={{ fontWeight: 'bold', fontSize: '2em', textDecoration: 'underline' }}>
  5. Changes to This Top-Secret Document
</h2>
<p className="text" style={{ fontSize: '1.2em', lineHeight: '1.5' }}>
